...
numOfFoldsPerTrial = 10 # Chia thành 10 fold

def evaluatePerformance(numTrials=100): # Khởi tạo 100 Trials
    '''
    ...
    ** Note that your implementation must follow this API**
    ...
    # Load Data
    filename = 'SPECTF.dat' # load dữ liệu
    data = np.loadtxt(filename, delimiter=',')
    X = data[:, 1:] # gán 44 giá trị sau cho X
    y = np.array([data[:, 0]]).T # gán nhãn, giá trị đầu cho Y
    n,d = X.shape
    ...
    # perform 100 trials - Trộn dữ liệu
